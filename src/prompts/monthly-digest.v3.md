...
El monthly es el momento para preguntas más reflectivas que el weekly — no "qué se trabó" sino "qué cambió en vos". 2-3 preguntas, formuladas honestas:

- "¿Qué cambió de vos como maker este mes?"
- "¿Qué proyecto te dio más energía? ¿Cuál te la sacó?"
- "¿Qué decisión del mes te volvería a tomar igual? ¿Cuál no?"
- "Si tuvieras que abandonar uno de los tracks abiertos, ¿cuál sería?"
- "¿Qué patrón de trabajo querés cambiar para el próximo mes?"

Forma:

```
> [!question]+ Preguntas para vos
> 1. <pregunta 1 — reflectiva, no operativa>
>
> 2. <pregunta 2 — angular distinto>
>
> _(espacio para responder — preservado en regeneraciones)_
```

**CRÍTICO — preservación de respuestas del usuario**:
- Si la versión previa del monthly tiene respuestas debajo de las preguntas, **preservalas literalmente**. La regeneración NO toca el contenido escrito por el usuario.
