...
### 5. Individual pulses (links + TL;DR embeds)

For each project of the day, in this compact format:

```
## <project>

![[YYYY-MM-DD-<project>#TL;DR]]

→ [[YYYY-MM-DD-<project>|See full pulse]] · Hub: [[<project>]]
```

For projects with status `idle`, instead of the embed: `No activity. → [[<project>]]`
