...
say "configura el vault de Obsidian, instala el scheduler nightly ($SCHEDULER_NAME)"
say "para correr el pulse automáticamente todos los días a las 10:00 AM, y ofrece"
say "instalar la skill /daily-pulse para Claude Code."
say ""
say "Para instalar la skill /daily-pulse por separado (correr Janus desde cualquier"
say "sesión de Claude Code):"
say ""
say "    ${BOLD}bash $JANUS_PATH/scripts/install-skill.sh${RESET}"
say ""
